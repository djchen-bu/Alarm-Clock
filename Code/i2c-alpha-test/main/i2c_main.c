...
#define RW_TEST_LENGTH                     8              /*!<Data length for r/w test, any value from 0-DATA_LENGTH*/
...
void app_main()
{
	...
	displaybuffer = writeDigitAscii(0, 48, displaybuffer);
	displaybuffer = writeDigitAscii(1, 49, displaybuffer);
	displaybuffer = writeDigitAscii(2, 50, displaybuffer);
	displaybuffer = writeDigitAscii(3, 51, displaybuffer);
